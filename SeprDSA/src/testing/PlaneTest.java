...
public class PlaneTest {
	...
	public void testToString() {
		EntryExitPoint testEEP1 = new EntryExitPoint(new BasicVector(new double[] { 12, 300, 0 }),1,20,12);
		WayPoint testWP = new WayPoint(new BasicVector(new double[] { 0, 0, 0 }), "1");
		...
		assertEquals("This should return the string Plane12345678", "Plane12345678", test1.toString());
	}

	@Test
	public void testIsCollidingPos() {
		EntryExitPoint testEEP1 = new EntryExitPoint(new BasicVector(new double[] { 12, 300, 0 }),1,20,12);
		EntryExitPoint testEEP2 = new EntryExitPoint(new BasicVector(new double[] { 12, 300, 0 }),1,20,12);
		WayPoint testWP = new WayPoint(new BasicVector(new double[] { 0, 0, 0 }), "1");
		wayPointList.add(testWP);
		...
		Plane test1 = new Plane("ABCDEFGH", wayPointList, enterPoint1, exitPoint2);
		Plane test2 = new Plane("abcdefgh", wayPointList, enterPoint2, exitPoint1);
	...
	public void testIsCollidingObj() {
		...
		Plane test1 = new Plane("ABCDEFGH", wayPointList, enterPoint1, exitPoint2);
		Plane test2 = new Plane("abcdefgh", wayPointList, enterPoint2, exitPoint1);
		assertEquals("This should return true as as the points are colliding", true, test1.isCollidingObj(test2));
	}
